      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <Link to="/" className="font-medium hover:text-websec-purple transition-colors">Home</Link>
            <Link to="/learning-paths" className="font-medium hover:text-websec-purple transition-colors">Learn</Link>
            <Link to="/labs" className="font-medium hover:text-websec-purple transition-colors">Labs</Link>
            {isLoggedIn && (
              <Link to="/dashboard" className="font-medium hover:text-websec-purple transition-colors">Dashboard</Link>
            )}
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 py-2 border-t">
            <div className="flex flex-col space-y-3">
              <Link to="/" 
                className="font-medium hover:text-websec-purple transition-colors px-2 py-1"
